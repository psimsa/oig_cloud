...
class OigCloudApi:
    ...
    async def set_boiler_mode(self, mode: int) -> bool:
    ...
    async def set_battery_formating(self, mode: int) -> bool:
        with tracer.start_as_current_span("set_battery_formating") as span:
            try:
