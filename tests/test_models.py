...
class TestModels(unittest.TestCase):
    ...
    def test_ac_in_b_data(self):
        ...
        ac_in_b_data = {"aci_wr": 100.0, "aci_ws": 200.0, "aci_wt": 300.0}
    ...
    def test_boiler_data(self):
        ...
        boiler_data = {"p": 2000.0, "ssr1": 1, "ssr2": 1, "ssr3": 0}
    ...
    def test_device_data(self):
        ...
        device_data = {"id_type": 1, "lastcall": "2025-04-05 12:34:56"}
